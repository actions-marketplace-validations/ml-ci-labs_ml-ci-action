...
The screenshot above is a real GitHub PR comment produced by ML-CI v0.1.1. Each run creates or updates one idempotent comment with the following sections:
...
<details>
<summary>Raw comment markdown example</summary>
