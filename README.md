...
![Example ML-CI PR comment from a real GitHub pull request using v0.1.1](./docs/assets/pr-comment-screenshot.png)

_Real GitHub PR comment generated by ML-CI v0.1.1._
...
> - Threshold-only regression gating in v0.1.1
  ...
  validate:
    ...
    steps:
      ...
      - name: Validate model changes
        uses: ml-ci-labs/ml-ci-action@v0.1.1
        with:
...
| `regression-test` | No | `threshold` | Regression method. Only `threshold` is supported in v0.1.1. |
...
| precision | 0.9250 | 0.9400 | +0.0150 | +1.6% | :white_check_mark: |
| recall | 0.8950 | 0.9200 | +0.0250 | +2.8% | :white_check_mark: |
...
- :white_check_mark: Schema validation passed
- :white_check_mark: No columns with >5% missing values
- :warning: 1 duplicate rows (3.3% of data)
- :warning: Distribution drift detected in 1 column(s)
  - `feature_b`: PSI = 0.169

### Model Card

Model card generated at `/github/workspace/./MODEL_CARD.md`

### Summary

- All 5 metrics within tolerance (5 improved)
- Data quality: :white_check_mark: Passed

---
*Generated by [ML-CI](https://github.com/ml-ci-labs/ml-ci-action) v0.1.1*
```
...
CSV and Parquet are supported in v0.1.1.
...
- No dashboard or billing flow in v0.1.1
...
| `ml-ci-action` | One-step GitHub-native validation and reporting | No hosted history or compliance layer in v0.1.1 |
